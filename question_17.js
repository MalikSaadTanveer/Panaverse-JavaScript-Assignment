...
guests.unshift("akbar");

let start = 2;
let deleteCount = 0;
guests.splice(start, deleteCount, 'umer');
guests.push("zuhaib")
for (const guest of guests) {
    console.log(`${guest} , you are invited to the dinner`);
}
