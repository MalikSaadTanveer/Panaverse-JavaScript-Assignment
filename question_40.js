...
console.log(make_album("Nusrat fateh ali khan","Dil Pe Zakham Khate Hain"));
console.log(make_album("Nusrat fateh ali khan","Aisa Banna Sanwarna"));
console.log(make_album("Sidhu moose wala","295",8));
